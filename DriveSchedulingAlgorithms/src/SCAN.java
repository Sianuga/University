...
public class SCAN
{
    ...
    private int time=0,currentCylinderPos=0,armMovesCounter=0, lastProcessCylinder, firstProcessCylinder;
    private boolean showInfo=false, movingUp=true;
    private final int MAX_VALUE=200;

    SCAN(Process[] processes)
    {
...
//            }
    ...
    {
        System.out.println("Number of cylinders travelled by head of hard drive arm in SCAN algorithm is: "+ armMovesCounter);
        System.out.println();
    }
}
